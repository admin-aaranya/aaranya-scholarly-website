...
// ----------------------
// lib/galley.js builds the published HTML full text of an article from the
// accepted Word file, and needs the words out of it first. That output is
// what readers read and what search engines index, so this module sits on the
// path to the version of record -- higher stakes than the removed manuscript
// assistant it was originally written for.
//
// Tracked changes are the reason to care about the details: text the author
// deleted must not come out, or a retracted sentence ends up published.
//
// WHY NOT A LIBRARY
// -----------------
